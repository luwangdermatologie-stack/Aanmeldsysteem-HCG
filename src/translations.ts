...
export const translations: Record<LanguageCode, TranslationSet> = {
  NL: {
    ...
    apptDetailsTitle: "Tijdstip & bij wie",
    apptDetailsSub: "Voer het geplande tijdstip in en kies bij wie u een afspraak heeft.",
    apptTimeLabel: "Uur van uw afspraak (bv. 14:30)",
    apptDoctorLabel: "Bij wie",
    selectDoctorPlaceholder: "Selecteer bij wie...",
  ...
  EN: {
    ...
    apptDetailsTitle: "Time & with whom",
    apptDetailsSub: "Enter your scheduled time and choose who your appointment is with.",
    apptTimeLabel: "Appointment Time (e.g. 14:30)",
    apptDoctorLabel: "With whom",
    selectDoctorPlaceholder: "Select with whom...",
  ...
  FR: {
    ...
    apptDetailsTitle: "Heure & avec qui",
    apptDetailsSub: "Indiquez l'heure prévue et choisissez avec qui vous avez rendez-vous.",
    apptTimeLabel: "Heure du rendez-vous (ex: 14:30)",
    apptDoctorLabel: "Avec qui",
    selectDoctorPlaceholder: "Sélectionnez avec qui...",
  ...
  TR: {
    ...
    apptDetailsTitle: "Saat & kiminle",
    apptDetailsSub: "Planlanan saati girin ve randevunuzun kiminle olduğunu seçin.",
    apptTimeLabel: "Randevu Saati (örn. 14:30)",
    apptDoctorLabel: "Kiminle",
    selectDoctorPlaceholder: "Kiminle olduğunu seçin...",
  ...
  AR: {
    ...
    apptDetailsTitle: "الوقت ومع من",
    apptDetailsSub: "أدخل وقت موعدك المحدد وحدد مع من لديك موعد.",
    apptTimeLabel: "وقت الموعد (مثال 14:30)",
    apptDoctorLabel: "مع من",
    selectDoctorPlaceholder: "حدد مع من...",
